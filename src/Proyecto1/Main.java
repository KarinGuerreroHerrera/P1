...
public class Main {
    ...
    private static void mostrarMenuPrincipal() {
        ...
        System.out.println("7. Listar Learning Paths de un profesor");
        System.out.println("8. Modificar Learning Path de un profesor");
        System.out.println("9. Eliminar Learning Path de un profesor");
        System.out.println("10. Asignar actividad a Learning Path");
        System.out.println("11. Calificar evaluación");
        System.out.println("12. Ver progreso de estudiantes en un Learning Path");
    ...
    private static void iniciarSesionEstudiante() {
        ...
        if (estudiante != null) {
            Profesor profesor = obtenerProfesor(estudiante.getIdProfesor()); 
            if (profesor != null) {
                mostrarMenuEstudiante(estudiante, profesor); 
            } else {
                System.out.println("Profesor no encontrado para este estudiante.");
            }
        } else {
    ...
    private static void mostrarMenuEstudiante(Estudiante estudiante, Profesor profesor) {
        boolean salir = false;
        while (!salir) {
            ...
            System.out.println("6. Crear Learning Path para el profesor"); 
            System.out.println("7. Modificar Learning Path");
            System.out.println("8. Asignar Actividad");
            System.out.println("9. Calificar Evaluación");
            System.out.println("10. Ver Progreso de Estudiantes");
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    verProgresoEstudiantes(estudiante);
                    break;
                case 4:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    asignarActividad(profesor);
                    break;
                case 9:
                    calificarEvaluacion(profesor);
                    break;
                case 10 :
                System.out.print("Ingrese el ID del Learning Path: ");
                int idLearningPath = scanner.nextInt();
                scanner.nextLine();
                profesor.verProgresoEstudiantes(idLearningPath); 
                    break;
                case 11:
                    salir = true;
                    break;
    ...
    private static void verProgresoEstudiantes(Estudiante estudiante) {
        System.out.println("Ingrese ID del Learning Path:");
        int idLP = scanner.nextInt();
        scanner.nextLine();
    ...
    private static void calificarEvaluacion(Profesor profesor) {
        System.out.println("Ingrese ID del Quiz:");
        int idQuiz = scanner.nextInt();
        scanner.nextLine();
    
        Quiz quiz = obtenerQuiz(idQuiz); 
        if (quiz == null) {
        ...
        profesor.calificarEvaluacion(quiz, respuestasEstudiante, quiz.getRespuestasCorrectas()); 
    }
    private static void asignarActividad(Profesor profesor) {
        System.out.println("Ingrese el ID del Learning Path:");
        int idLearningPath = scanner.nextInt();
        scanner.nextLine();
        
        LearningPath lp = obtenerLearningPath(idLearningPath); 
        if (lp == null) {
            System.out.println("Learning Path no encontrado.");
            return;
        }
        ...
        scanner.nextLine();  
        int idActividad = lp.generarIdActividad(); 
        Actividad actividad = new Actividad(nombreActividad, tipoActividad, idActividad, descripcionActividad, objetivoActividad, nivelDificultadActividad, duracionActividad);
        profesor.asignarActividad(idLearningPath, actividad);
    }
    private static Quiz obtenerQuiz(int idQuiz) {
